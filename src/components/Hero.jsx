...
export default function Hero() {
  ...
  <span className="typing">
    Hi, I&apos;m <span className="text-blue-600 dark:text-blue-400">Mohsin Khan</span>
  </span>
</h1>
  ...
  <li className="grid grid-cols-[16px_1fr] gap-3 items-start">
    ...
    <span className="font-medium">Web MERN Stack Developer</span>
  </li>

  <li className="grid grid-cols-[16px_1fr] gap-3 items-start">
    <span className="text-blue-600 dark:text-blue-400 font-extrabold leading-[1.4] text-lg">•</span>

    <span className="font-medium">Building Efficient & Scalable Web Applications</span>
  </li>

  <li className="grid grid-cols-[16px_1fr] gap-3 items-start">
    <span className="text-blue-600 dark:text-blue-400 font-extrabold leading-[1.4] text-lg">•</span>

    <span className="font-medium">AI-Powered Features & API Integrations</span>
  </li>

  <li className="grid grid-cols-[16px_1fr] gap-3 items-start">
    <span className="text-blue-600 dark:text-blue-400 font-extrabold leading-[1.4] text-lg">•</span>

    <span className="font-medium">Leading freelance projects from requirements to deployment</span>
  </li>
